...
function readConfig() {
  ...
  return {
    ...
    databaseConnectionTimeoutMs: readIntEnv("MJI_DATABASE_CONNECTION_TIMEOUT_MS") || 10_000,
    databaseSslMode: readTextEnv("MJI_DATABASE_SSL_MODE") || "prefer",
    databaseApplicationName: readTextEnv("MJI_DATABASE_APPLICATION_NAME") || "mji-wechat-core",
